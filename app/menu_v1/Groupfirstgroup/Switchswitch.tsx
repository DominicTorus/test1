...
const Switchswitch = ({checkToAdd,setCheckToAdd,encryptionFlagCompData}:any) => {
 ...
 /////////////
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "b4e2e5dd1960491dab9c2a2e633a515a",
          isTable: false,
          from:"Switchswitch",
  ...
  useEffect(() => {
    handleMapperValue()
    setfirstgroupc4acb((pre:any)=>({...pre,switch:null}))
  },[switcha515a?.refresh])


  const handleChange = async (e:any) => {
    setfirstgroupc4acb((prev: any) => ({ ...prev, switch: e.target.checked }))
  ...
  if (switcha515a?.isHidden) {
    return <></>
  }
  return (
    <div 
      style={{gridColumn: `4 / 6`,gridRow: `38 / 48`, gap:``, height: `100%`, overflow: 'auto'}} >
      <Switch
        className=""
        size='m'
        disabled= {switcha515a?.isDisabled ? true : false}
        content="over 18"
        checked={firstgroupc4acb?.switch || false} 
