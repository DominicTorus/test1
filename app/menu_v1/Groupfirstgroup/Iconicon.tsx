...
const Iconicon = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:CG:AFGK:TG2:AFK:AllComponents:AFVK:v1",  componentId:"5909e18973e149f19bb5db9d38fc4acb",controlId:"1c9512ba532641ed81e1b9e7e3871de8",isTable:false,accessProfile:accessProfile,from:"Iconicon"},{
      headers: {
  ...
  if (icon71de8?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `11 / 13`,gridRow: `136 / 152`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={45}
